...
<html lang="en">
    ...
    <head>
        ...
        <script>
            ...
            function showProperties()
            {
                ...
                xhttp.onreadystatechange = function () {
                    if (this.readyState == 4 && this.status == 200) {
                        ...
                        for (var i = 0; i < arr.length; i++)
                        {
                            ...
                            ans = ans + "<a href=\"OwnerEditPerPropertity.jsp?detailid="+st.detailid+"\" class=\"grid_item\" style=\"width: 350px; height: 220px\" >";
                            ans = ans + "<figure>";
                            ans = ans + "<img src=\'"+st.photo+"\' class=\"img-fluid\" alt=\"\">";
                            ans = ans + "<div class=\"info\">";
                            ans = ans + "<h2 style=\"color: white\" >"+st.propertyname+"</h2>";
                            ans = ans + "<p style=\"color: white\" >"+st.address+"</p>";
                            ans = ans + "</div>";
                            ans = ans + "</figure>";
                            ans = ans + "</a>";
                            ans = ans + "</div>";
                ...
                xhttp.open("Post", "./OwnerShowEditPropertiesServlet", true);
    ...
    <body class="datepicker_mobile_full" onload="showProperties()" ><!-- Remove this class to disable datepicker full on mobile -->
                ...
                <div class="container container-custom margin_30_95">
                    <section class="add_bottom_45">
                        <div class="main_title_3">
                            <h2>Manage/Edit your Property !</h2>
