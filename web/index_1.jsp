                ...
                xhttp.onreadystatechange = function () {
                    if (this.readyState == 4 && this.status == 200) {
                        ...
                        for (var i = 0; i < arr.length; i++)
                        {
                            ...
                            ans = ans + "<div class=\"box_grid\">";
                            ans = ans + "<figure>";
//                            ans = ans + "<a class=\"wish_bt\"></a>";
                            ans = ans + "<a onclick=\"viewpropertyOwner(\'" + st.cityname + "\')\" ><img src=" + st.photo + " class=\"img-fluid\" width=\"800\" height=\"533\"><div class=\"read_more\"><span>View Airbnb's</span></div></a>";

                            ans = ans + "<small>Historic</small>";
                            ans = ans + "</figure>";
                            ans = ans + "<div class=\"wrapper\">";
                            ans = ans + "<h3><a href=\"#\" onclick=\"viewpropertyOwner(\'" + st.cityname + "\')\" >" + st.cityname + "</a></h3>";
                            ans = ans + "<p>" + st.desc + "</p>";
                            ans = ans + "</div>";
//                            ans = ans + "<ul>";
//                            ans = ans + "<li><i class=\"icon_clock_alt\"></i> 1h 30min</li>";
//                            ans = ans + "<li><div class=\"score\"><span>Superb<em>350 Reviews</em></span><strong>8.9</strong></div></li>";
//                            ans = ans + "</ul>";
                            ans = ans + "</div>";
                            ans = ans + "</div>";
                        }
                ...
                xhttp.open("POST", "./UserShowCitiesServlet", true);
                //3. Send Request
                xhttp.send();
            ...
            function viewpropertyOwner(cityname)
            {
                ...
                {
                    window.location.href = "OwnersViewProperty.jsp?cityname=" + cityname + " ";
                }
            }
    ...
    <body class="datepicker_mobile_full" onload="showCities()" ><!-- Remove this class to disable datepicker full on mobile -->
            ...
            <main>
                ...
                <div class="container container-custom margin_80_0">
                    <div class="main_title_2">
                        <span><em></em></span>
                        <h2>Major Attractions of India</h2>
