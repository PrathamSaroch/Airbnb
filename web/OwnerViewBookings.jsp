    ...
    <head>
        ...
        <script>
            ...
            function showBookings()
            {
                ...
                xhttp.onreadystatechange = function () {
                    if (this.readyState == 4 && this.status == 200) {
                        ...
                        for (var i = 0; i < arr.length; i++)
                        {
                            ...
                            ans = ans + "<label class=\"card-text text-alli\" style=\"font-size: 16px;text-align: center;color: #005b9a\" >Property Booked Address : <br><br>" + st.address + "</label><br><br>";
                            ...
                            ans = ans + "<div class=\"card-body\">";
                            ans = ans + "<label class=\"card-text text-alli\" style=\"font-size: 16px;text-align: center;color: #005b9a\" >User Email : <br><br>" + st.useremail + "</label><br><br>";
                            ...
                            ans = ans + "<div class= \"col-sm-2\" style=\"text-align: center\" >";
                            ans = ans + "<div class=\"card-body\">";
                            ans = ans + "<label class=\"card-text text-alli\" style=\"font-size: 16px;text-align: center;color: #005b9a\" >Mode of Payment : <br><br>" + st.paymenttype + "</label><br><br>";
                            ...
                            ans = ans + "<div class= \"col-sm-2\" style=\"text-align: center\" >";
                            ans = ans + "<div class=\"card-body\">";
                            ans = ans + "<label class=\"card-text text-alli\" style=\"font-size: 16px;text-align: center;color: #005b9a\" >Grand Total : <br><br>" + st.totalprice + "</label><br><br>";
                ...
                xhttp.open("Post", "./OwnerViewBookingsServlet", true);
                    ...
                    <div>
                        <div class="row" style="text-align: center" >
                            ...
                            <div class="col-sm-12 text-center"  style="border: 2px solid black; border-radius: 10px" >
                                <h1>Your Booked Properties</h1><br><br>
                                <div id="showbookings" >
